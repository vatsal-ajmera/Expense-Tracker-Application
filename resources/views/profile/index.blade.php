                    ...
                    <form method="post" id='updateAvatarForm' action="{{ Route('profile.avatar.post')}}">
                        <div class="profile-top">
                            <div class="profile-content">
                                <div class="profile-contentimg">
                                    @if (! empty($auth_user->avatar))
                                        <img src="{{ asset('storage/uploads/profile').'/'.$auth_user->avatar }}" alt="img"
                                            id="blah">
                                    @else
                            ...
                            <div class="ms-auto">
                                ...
                                <button class="btn btn-submit me-2" type="button" id="loaderBtn" disabled
                                    style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="toggleInput" name='two_fa_varications' {{ $auth_user->two_fa_varications == 1 ? 'checked' : '' }}>
                                <label for="toggleInput" class="toggle-label">
